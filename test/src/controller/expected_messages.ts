...
export const build_expected_messages = (user: User) => ([
    ...
    {
        "body": "It's time for the big reveal! 😍 Check out your private journal here: http://localhost:3000/u/123",
    ...
    {
        "body": "One last thing: would you mind giving me some feedback on your experience? https://aryel1.typeform.com/to/uXF0sA",
